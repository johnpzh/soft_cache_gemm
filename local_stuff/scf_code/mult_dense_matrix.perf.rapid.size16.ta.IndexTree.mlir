module {
  func.func @main() {
    %0 = "ta.dense_tensor_decl"() <{allocator = "rapid", format = "Dense"}> : () -> tensor<16x16xf64>
    %1 = "ta.dense_tensor_decl"() <{allocator = "rapid", format = "Dense"}> : () -> tensor<16x16xf64>
    %2 = "ta.dense_tensor_decl"() <{allocator = "rapid", format = "Dense"}> : () -> tensor<16x16xf64>
